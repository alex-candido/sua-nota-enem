...
import { UserApiInMemoryRepository } from '../../../../../core/modules/v1/users-module/infra/db/in-memory/repositories/user-api-in-memory.repository';
...
export const REPOSITORIES = {
  ...
  USER_IN_MEMORY_REPOSITORY: {
    provide: UserApiInMemoryRepository,
    useClass: UserApiInMemoryRepository,
  },
};
export const USE_CASES = {
  CREATE_ONE_USER_USE_CASE: {
    ...
    inject: [REPOSITORIES.USER_PRISMA_REPOSITORY.provide],
  },
